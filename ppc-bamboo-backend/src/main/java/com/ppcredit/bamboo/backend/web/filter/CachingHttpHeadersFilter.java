package com.ppcredit.bamboo.backend.web.filter;
...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(PPCreditProperties ppcProperties) {
        this.ppcProperties = ppcProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        CACHE_TIME_TO_LIVE = TimeUnit.DAYS.toMillis(ppcProperties.getHttp().getCache().getTimeToLiveInDays());
    }
