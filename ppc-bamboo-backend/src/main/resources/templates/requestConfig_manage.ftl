						...
						<div class="row" id="dataBox" >
							<div class="col-md-12 ">
								...
								<div class="box border primary">
									<div class="box-title">
										<h4><i class="fa fa-user"></i><span class="hidden-inline-mobile"><font style="font-size:16px;">系统管理</font><font style="font-size:20px;">>请求参数配置</font></span></h4>
									</div>
									<div class="box-body">
										<div class="tabbable header-tabs ">
											<ul class="nav nav-tabs">
											    <!-- <ppd:auth ctype="add" menuid="1007" parentid="1001"> -->
											  ...
											  <!-- <ppd:auth ctype="add" menuid="1007" parentid="1001">-->
																	...
																	<div class="box border purple">
																		...
																		<div class="box-body big">
																			<div class="row">
																			  ...
																			  <div class="col-xs-2">
																				&nbsp;<button id="search" class="btn btn-warning tip-bottom form-control" title="" style="" data-original-title="查询">查询</button>
																			  </div>
																			  <div class="col-xs-1">
																				&nbsp;<button id="init" class="btn btn-warning tip-bottom form-control" title="" data-original-title="初始化">初始化</button>
																			  </div>
																			  <div class="col-xs-1">
																				&nbsp;<button id="reset" class="btn btn-warning tip-bottom form-control" title="" data-original-title="重置">重置</button>
																			  </div>
																			  <div class="col-xs-1">
																				&nbsp;<button id="submit" class="btn btn-warning tip-bottom form-control" title="" data-original-title="提交">提交</button>
																			  </div>
												...
												<!--  </ppd:auth>-->
												  ...
												  <div id="pro_edit" class="tab-pane fade">
														...
														<div class="row">
															 <div class="col-md-12">
																<div class="box border green">
																	<div class="box-title">
																		<h4><i class="fa fa-bars"></i>请求参数新增</h4>
																	</div>
																	<div class="box-body big">
																		<div class="row">
																		 <div class="col-md-12">
												   ...
												   <!-- /新增 -->
												   <!-- 修改 -->
											  	   <div id="config_edit" class="tab-pane fade">
													  <form id="editForm" class="form-horizontal" action="#">
														<div class="row">
															 <div class="col-md-12">
																<div class="box border green">
																	<div class="box-title">
																		<h4><i class="fa fa-bars"></i>请求参数修改</h4>
																	</div>
																	<div class="box-body big">
																		<div class="row">
																		 <div class="col-md-12">
																			...
																			<div class="form-group">
																			   <label class="col-md-4 control-label">执行顺序</label> 
																			   <div class="col-md-8">
																					<input type="text" id="orders" name="orders" value=""/>
																			   </div>
																			</div>
																			<h4>参数信息</h4>
																			<div class="form-group">
														  ...
														  <div class="form-actions clearfix" class="col-md-12"> 
														  	...
														  	<div align="left">
															  	<input type="submit" id="updateButton" value="保存"  class="btn btn-primary" onclick="updateConfig()"/>&nbsp;&nbsp;&nbsp; 
															  	<input type="button" value="返回" class="btn btn-primary" onclick="returnApi()" />
														  	</div>
														  </div>
													  </form>
...
<script src="${ctx }/js/requestConfig_manage.js"></script>
