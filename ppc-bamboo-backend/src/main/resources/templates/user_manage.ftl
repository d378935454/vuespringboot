        ...
        <div class="container">
            <div class="row">
                <div id="content" class="col-lg-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="box border primary">
                                <div class="box-title">
                                    <h4><i class="fa fa-user"></i><span class="hidden-inline-mobile"><font
                                            style="font-size:16px;">客户管理</font><font style="font-size:20px;">>用户/appkey管理</font></span>
                                    </h4>
                                </div>
                                <div class="box-body">
                                    <div class="tabbable header-tabs ">
                                        <ul class="nav nav-tabs">
                                            <!-- 											<ppd:auth ctype="add" menuid="1002" parentid="1001"> -->
                                            <!-- 											   <li><a href="#user_add" data-toggle="tab"><i class="fa fa-edit"></i> <span class="hidden-inline-mobile">新增用户</span></a></li> -->
                                            <!-- 											 </ppd:auth> -->
                                            <!--<ppd:auth ctype="add" menuid="1002" parentid="1001">-->
                                            <li class="active"><a href="#user_overview" data-toggle="tab" id="lookUser"><i
                                                    class="fa fa-dot-circle-o"></i> <span class="hidden-inline-mobile">查看</span></a>
                                            </li>
                                            <!--</ppd:auth>-->
                                        </ul>
                                            ...
                                            <ppd:auth ctype="add" menuid="1002" parentid="1001">
                                                <div class="tab-pane fade in active" id="user_overview">
                                                            ...
                                                            <div class="box border purple">
                                                                ...
                                                                <div class="box-body big">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xs-3">
                                                                            关键字：<input class="form-control" type="text"
                                                                                       id="searchCondition"
                                                                                       name="searchCondition" size="10"
                                                                                       placeholder="公司名(产品名)/邮箱 /姓名/手机号 /APPKEY">
                                                                        </div>
                                                                        <div class="col-xs-2">
                                                                            &nbsp;
                                                                            <button id="search"
                                                                                    class="btn btn-warning tip-bottom form-control"
                                                                                    title="" data-original-title="查询">查询
                                                                            </button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <!-- TABLE -->
                                                        <div class="col-md-12">
                                                            <!--  id="showData" style="display:none" -->
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 userInfoBody">
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="col-md-8"><input type="text" id="company"
                                                                                             name="company"
                                                                                             class="form-control"
                                                                                             value=""></div>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="col-md-8"><input type="text" id="username"
                                                                                             name="username"
                                                                                             class="form-control"
                                                                                             value=""></div>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="col-md-8"><input type="email" id="email"
                                                                                             name="email"
                                                                                             class="form-control"
                                                                                             value=""></div>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="col-md-8"><input type="text" id="tel"
                                                                                             name="tel"
                                                                                             class="form-control"
                                                                                             value=""></div>
                                                            </div>
                                                            ...
                                                            <div class="form-group col-md-6">
                                                                ...
                                                                <div class="col-md-8"><input type="text" id="url"
                                                                                             name="url"
                                                                                             class="form-control"
                                                                                             value=""></div>
                                                            </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <div id="addUniteSet" class="col-md-7">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text"
                                                                                   class="form-control inputPositiveInteger"
                                                                                   id="addTotalCount"
                                                                                   name="addTotalCount">
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="text"
                                                                                   class="form-control inputPositiveInteger"
                                                                                   id="addDayCount" name="addDayCount">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 fontWeight">
                                                                    <div class="col-md-6">
                                                                        <input type="checkbox" name="addCheckAll"
                                                                               id="addCheckAll">&nbsp;全选
                                                                    </div>
                        ...
                        <!-- Modal -->
                        <div id="myModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel2"
                             aria-hidden="true">
                                        ...
                                        <form class="form-horizontal" id="resForm" action="#">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9"><input class="form-control" type="email"
                                                                                 id="inputEmail" name="email"/></div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">姓名：</label>
                                                    <div class="col-md-9"><input class="form-control" type="text"
                                                                                 id="inputRealName" name="realName"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3">手机号码：</label>
                                                    <div class="col-md-9"><input class="form-control" type="number"
                                                                                 id="inputTel" name="tel"/></div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <button class="btn btn-primary" id="btnSave" style="margin-left:350px;"
                                                    data-loading-text="loading...">确定
                                            </button>
                                        </form>
                                        <div style="margin-left: 450px;">
                                            <button type="button" class="btn btn-danger" style="margin-top: -52px;"
                                                    aria-hidden="true" id="close2">返回
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- /Modal -->
                        <!-- Modal -->
                        <div id="productConfigurationModal" class="modal fade" role="dialog"
                                ...
                                <div class="modal-content modal-table">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-danger" data-dismiss="modal" aria-hidden="true">返回
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <!-- /Modal -->
                        <!-- Modal -->
                        <div id="checkboxModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel4"
                             aria-hidden="true">
                            <div class="modal-dialog" style="width:500px; margin-top: 200px;">
                                <div class="modal-content modal-table">
                                    <div class="modal-header">
                                        ...
                                        <h4 id="myModalLabel4" style="text-align:center">产品配置确认</h4>
                                    </div>
                                    <div class="box-body">
                                        ...
                                        <div class="modal-footer">
                                            <button class="btn btn-primary" id="checkboxBtnSave"
                                                    onclick="checkboxBtnSave()">提交
                                            </button>
                        ...
                        <!-- /Modal -->
                        <!-- Modal -->
                        <div id="showAppModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel5"
                             aria-hidden="true">
                            <div class="modal-dialog" style="width:800px; margin-top: 200px;">
                                <div class="modal-content modal-table">
                                    <div class="modal-header">
                        ...
                        <!-- /Modal -->
                        <!-- Modal -->
                        <div id="addUserModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel6"
                             aria-hidden="true">
                                        ...
                                        <div class="col-md-12 userInfoBody" id="modalAddUserInfoBody">
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="modalAddRightInput">
                                                    <input class="form-control modalAddInput" disabled="disabled"
                                                           type="text" id="modalAddCompanyName"
                                                           name="modalAddCompanyName"/>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="modalAddRightInput">
                                                    <input class="form-control modalAddInput" disabled="disabled"
                                                           type="text" id="modalAddUsername" name="modalAddUsername"/>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="modalAddRightInput">
                                                    <input class="form-control modalAddInput" disabled="disabled"
                                                           type="email" id="modalAddEmail" name="modalAddEmail"/>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="modalAddRightInput">
                                                    <input class="form-control modalAddInput" disabled="disabled"
                                                           type="text" id="modalAddTel" name="modalAddTel"/>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="modalAddRightInput">
                                                    <input class="form-control modalAddInput" disabled="disabled"
                                                           type="text" id="modalAddStatus" name="modalAddStatus"/>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="modalAddRightInput">
                                                    <input class="form-control modalAddInput" disabled="disabled"
                                                           type="text" id="modalAddURL" name="modalAddURL"/>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <!-- /Modal -->
                        <!-- Modal -->
                        <div id="productDetailsModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel7"
                             aria-hidden="true">
                            <div class="modal-dialog" style="width:1283px; margin-top: 200px;">
                                <div class="modal-content modal-table">
                                    <div class="modal-header">
                                    ...
                                    <div class="box-body" id="modal7Body">
                                        <div class="col-md-12 userInfoBody" id="modal7UserInfoBody">
                                            <div class="col-md-6"><label
                                                    class="control-label modal7leftTitle">公司名(产品名)</label><span
                                                    id="modal7companyName"></span></div>
                                            <div class="col-md-6"><label
                                                    class="control-label modal7leftTitle">姓名</label><span
                                                    id="modal7Username"></span></div>
                                            <div class="col-md-6"><label
                                                    class="control-label modal7leftTitle">邮箱</label><span
                                                    id="modal7Email"></span></div>
                                            <div class="col-md-6"><label
                                                    class="control-label modal7leftTitle">手机号码</label><span
                                                    id="modal7Tel"></span></div>
                                            <div class="col-md-6"><label
                                                    class="control-label modal7leftTitle">状态</label><span
                                                    id="modal7Status"></span></div>
                                            <div class="col-md-6"><label
                                                    class="control-label modal7leftTitle">系统地址(URL)</label><span
                                                    id="modal7URL"></span></div>
                                            <div class="col-md-12"><label
                                                    class="control-label modal7leftTitle">AppKey</label><span
                                                    id="modal7AppKey"></span></div>
                                            <div class="col-md-12"><label class="control-label modal7leftTitle">AppSecret</label><span
                                                    id="modal7AppSecret"></span></div>
                                        </div>
                                        <div class="col-md-12" id="modal7ProductMothodBody">

                                        </div>
                                        <div class="modal-footer">
                                            <ppd:auth ctype="edit" menuid="62" parentid="">
                                                <button class="btn btn-primary" id="productDetailsInput">修改</button>
                                            </ppd:auth>
                                            <button class="btn btn-danger closeModal" data-dismiss="modal"
                                                    aria-hidden="true">关闭
                                            </button>
                                        </div>
                                    </div>
                        ...
                        <!-- /Modal -->
                        <!-- Modal -->
                        <div id="updateDetailsModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel8"
                             aria-hidden="true">
                            <div class="modal-dialog" style="width:1283px; margin-top: 200px;">
                                <div class="modal-content modal-table">
                                    <form class="form-horizontal" id="modal8Form" action="#">
                                            ...
                                            <div class="col-md-12 userInfoBody" id="mpdal8UserInfoBody">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="modal8RightInput">
                                                        <input class="form-control modal8Input" type="text"
                                                               id="modal8companyName" name="modal8companyName"/>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="modal8RightInput">
                                                        <input class="form-control modal8Input" type="text"
                                                               id="modal8Username" name="modal8Username"/>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="control-label modal8leftTitle">邮箱</label>
                                                    <div class="modal8RightInput">
                                                        <input class="form-control modal8Input" type="email"
                                                               id="modal8Email" name="modal8Email"/>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                        ...
                                        <div class="col-md-12" id="modal8ProductMothodBody">
                                            <div class="col-md-12">
                                                ...
                                                <div id="modal8UniteSet" class="col-md-6">
                                                    <div class="col-md-6">
                                                        <label class="floatLeft">总调用次数&nbsp;</label>
                                                        <input type="text" class="form-control inputPositiveInteger"
                                                               id="modal8TotalCount" name="modal8TotalCount">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="floatLeft">单日最高调用次数&nbsp;</label>
                                                        <input type="text" class="form-control inputPositiveInteger"
                                                               id="modal8DayCount" name="modal8DayCount">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <input type="submit" class="btn btn-primary" id="productDetailsSubmit"
                                                   value="提交"/>
                                            <input type="button" class="btn btn-danger" id="modal8Return" value="返回"/>
                                            <input type="button" class="btn btn-danger closeModal" id="modal8Close"
                                                   data-dismiss="modal" aria-hidden="true" value="关闭"/>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <!-- Modal -->
                    <div id="confirmDetailsModal" class="modal fade" role="dialog" aria-labelledby="myModalLabel9"
                         aria-hidden="true">
                        <div class="modal-dialog" style="width:1283px; margin-top: 200px;">
                            <div class="modal-content modal-table">
                                <div class="modal-header">
                                    ...
                                    <div class="col-md-12 userInfoBody" id="modal9UserInfoBody">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="modal9RightInput">
                                                <input class="form-control modal9Input" disabled="disabled" type="text"
                                                       id="modal9companyName" name="modal9companyName"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="modal9RightInput">
                                                <input class="form-control modal9Input" disabled="disabled" type="text"
                                                       id="modal9Username" name="modal9Username"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="control-label modal9leftTitle">邮箱</label>
                                            <div class="modal9RightInput">
                                                <input class="form-control modal9Input" disabled="disabled" type="email"
                                                       id="modal9Email" name="modal9Email"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="modal9RightInput">
                                                <input class="form-control modal9Input" disabled="disabled" type="text"
                                                       id="modal9Status" name="modal9Status"/>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
