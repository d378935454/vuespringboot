		...
		datatables = $('#datatableTable').dataTable({
			...
			"aoColumns" : [ {
	            ...
	            "fnRender": function (obj) {
	                ...
	                if(status == 'S'){
	                	return '<ppd:auth ctype="edit" menuid="1002" parentid="1001"><button value="'+id+'" class="btn btn-xs btn-info btn-freeze" style="margin-left:6px;" onclick="check(\''+realName+'\',\''+appKey+'\')">选中</button></ppd:auth>';
	                }
	                /*if (isActive == 'S') {
